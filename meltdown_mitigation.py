...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if temperature * neutrons_produced_per_second < threshold * 90/100:
        return 'LOW'
    if (temperature * neutrons_produced_per_second) <= threshold * 0.9 or \
    (temperature * neutrons_produced_per_second) == threshold or \
    (temperature * neutrons_produced_per_second) <= threshold * 1.1:
        return 'NORMAL'
